...
// Resource Info
// ==============================================
export class ResourceInfo extends BaseModelInfo {
    constructor({ apiDir, modelPath, onClosed }) {
    ...
    refreshMetadataSection() {
        ...
        const metadata = this.infoData.metadata ?? {};
        const prediction = metadata["modelspec.predict_key"] ?? metadata["modelspec.prediction_type"];
        this.metadataSection.addItem("推論", prediction);
    }
